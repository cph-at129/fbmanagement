...
var adInsightMetricsSchema = mongoose.Schema({
  website_ctr: [],
  adset_id: String,
  name: String,
  actions: [],
...
adInsightMetricsModel = mongoose.model('Ad_Insight_Metrics', adInsightMetricsSchema);

module.exports = adInsightMetricsModel
